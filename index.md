      ...
      <div class="max-w-2xl mx-auto">
        <div class="bg-white p-8 border-2 border-stone-900 shadow-[8px_8px_0px_0px_rgba(239,68,68,0.8)]">
          ...
          <div id="news-container" class="space-y-4">
            ...
            <div class="news-item flex gap-4 pb-4 border-b border-stone-200 last:border-0 hidden" data-index="5">
              <span class="font-display text-xs text-stone-500 whitespace-nowrap pt-1">Aug. 2024</span>
              <span class="text-base text-stone-700">Completed summer research internship focusing on educational robotics applications in underserved communities.</span>
            </div>
          </div>
...
<section id="teaching" class="py-20 px-8 bg-white">
  <div class="max-w-6xl mx-auto">
    ...
    <div class="mb-16">
      <h3 class="font-display font-bold text-sm text-red-500 mb-8 tracking-widest text-center">TEACHING ASSISTANT</h3>
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="bg-stone-50 p-6 border-l-4 border-red-500 hover:bg-red-50 transition-colors rounded-r-lg">
          <div class="flex items-start justify-between mb-3">
            <h4 class="font-display font-bold text-lg text-stone-900">STEM1001</h4>
            <span class="px-2 py-1 bg-stone-200 text-stone-600 font-display text-xs rounded-full">Lead Teaching Assistant</span>
          </div>
          <h5 class="font-semibold text-stone-800 mb-2">Introduction to Robotics</h5>
          <p class="text-stone-600 text-sm mb-4 leading-relaxed">Fundamentals of robotics programming and autonomous systems for high school students</p>
          <div class="flex flex-wrap gap-1">
            <span class="px-2 py-1 bg-red-100 text-red-700 font-display text-xs rounded">Fall 2023</span>
            <span class="px-2 py-1 bg-red-100 text-red-700 font-display text-xs rounded">Spring 2024</span>
            <span class="px-2 py-1 bg-red-100 text-red-700 font-display text-xs rounded">Fall 2024</span>
          </div>
        </div>
        
        <div class="bg-stone-50 p-6 border-l-4 border-stone-500 hover:bg-stone-50 transition-colors rounded-r-lg">
          <div class="flex items-start justify-between mb-3">
            <h4 class="font-display font-bold text-lg text-stone-900">STEM2002</h4>
            <span class="px-2 py-1 bg-stone-200 text-stone-600 font-display text-xs rounded-full">Teaching Assistant</span>
          </div>
          <h5 class="font-semibold text-stone-800 mb-2">Advanced Mathematics</h5>
          <p class="text-stone-600 text-sm mb-4 leading-relaxed">Calculus and linear algebra for STEM students</p>
          <div class="flex flex-wrap gap-1">
            <span class="px-2 py-1 bg-stone-100 text-stone-700 font-display text-xs rounded">Spring 2023</span>
            <span class="px-2 py-1 bg-stone-100 text-stone-700 font-display text-xs rounded">Spring 2024</span>
          </div>
        </div>
        
        <div class="bg-stone-50 p-6 border-l-4 border-amber-500 hover:bg-amber-50 transition-colors rounded-r-lg">
          <div class="flex items-start justify-between mb-3">
            <h4 class="font-display font-bold text-lg text-stone-900">STEM1003</h4>
            <span class="px-2 py-1 bg-stone-200 text-stone-600 font-display text-xs rounded-full">Teaching Assistant</span>
          </div>
          <h5 class="font-semibold text-stone-800 mb-2">Programming Fundamentals</h5>
          <p class="text-stone-600 text-sm mb-4 leading-relaxed">Introduction to Python programming for beginners</p>
          <div class="flex flex-wrap gap-1">
            <span class="px-2 py-1 bg-amber-100 text-amber-700 font-display text-xs rounded">Fall 2022</span>
            <span class="px-2 py-1 bg-amber-100 text-amber-700 font-display text-xs rounded">Fall 2023</span>
            <span class="px-2 py-1 bg-amber-100 text-amber-700 font-display text-xs rounded">Fall 2024</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div>
      <h3 class="font-display font-bold text-sm text-red-500 mb-6 tracking-widest text-center">STUDENT MENTORING</h3>
      <div class="max-w-3xl mx-auto text-center">
        <p class="text-stone-600 leading-relaxed">Currently building my mentoring portfolio through hands-on robotics and programming projects with high school students.</p>
      </div>
    </div>
  </div>
</section>
