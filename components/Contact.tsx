    ...
    <Section id="contact" title="Get in Touch">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex justify-center space-x-6 mb-8">
          <a href="mailto:mwazakd@gmail.com" className="text-sky-400 hover:text-sky-300 transition-colors">mwazakd@gmail.com</a>
          <span className="text-slate-600">|</span>
          <a href="https://www.linkedin.com/in/kudzaishe-mwaza-3630a42a2" target="_blank" rel="noopener noreferrer" className="text-sky-400 hover:text-sky-300 transition-colors">LinkedIn</a>
        </div>
      </div>
